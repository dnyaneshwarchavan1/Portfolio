...
export const ABOUT_CONTENT = `Motivated Full Stack Developer and Bachelor of Computer Application student specializing in IT. Skilled in designing, developing, and deploying web and mobile applications, with hands-on experience in full stack development.Proficient in creating responsive, user-friendly interfaces.`;
...
export const EDUCATION = [
  {
    institution: "SHRI DATTA COLLEGE, HADGAON",
    university: "Swami Ramanand Teerth Marathwada University, Nanded",
    percentage: "8.28 CGPA",
    year: "2022-2025",
    degree: "BCA",
    location: "Hadgaon, Maharashtra",
    level: "college",
  },
  {
    institution: "HUTATMA JAYWANTRAO PATIL JUNIOR COLLEGE, HIMAYATNAGER",
    university: "Maharashtra State Board ",
    percentage: "58.17%",
    year: "2022",
    degree: "(12<sup>th</sup>)",
    location: "Himayatnager, Maharashtra",
    level: "higher-secondary",
  },
  {
    institution: "RAJA BHAGIRATH SECONDARY AND HIGHER SECONDARY SCHOOL, HIMAYATNAGER",
...
export const CONTACT = {
  phoneNo: "+91 8080879635",
  email: "chavandnyaneshvar3@gmail.com",
  linkedin:
    "https://www.linkedin.com/in/dnyaneshwar-chavan-aa6399254?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
  github: "https://github.com/dnyaneshwarchavan1",
  x: "https://x.com",
